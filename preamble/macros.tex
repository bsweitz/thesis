...
\newcommand{\matching}{\left\{x_{ij}^2 - x_{ij} \mid i,j \in [n]\right\} \cup \left\{\sum_i x_{ij} - 1 \mid j \in [n]\right\} \cup \left\{x_{ij}x_{ik} \mid i,j,k \in [n]\right\}}
\newcommand{\tsp}{\left\{x_{ij}^2 - x_{ij} \mid i,j \in [n]\right\} \cup \left\{\sum_i x_{ij} - 1 \mid j \in [n]\right\} \cup \left\{x_{ij}x_{ik}, x_{ji}x_{ki} \mid i,j,k \in [n]\right\}}
