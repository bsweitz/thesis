...
\newcommand{\matching}{\left\{x_{ij}^2 - x_{ij} | i,j \in [n]\right\} \cup \left\{\sum_i x_{ij} - 1 | j \in [n]\right\} \cup \left\{x_{ij}x_{ik} | i,j,k \in [n]\right\}}
\newcommand{\tsp}{\left\{x_{ij}^2 - x_{ij} | i,j \in [n]\right\} \cup \left\{\sum_i x_{ij} - 1 | j \in [n]\right\} \cup \left\{x_{ij}x_{ik}, x_{ji}x_{ki} | i,j,k \in [n]\right\}}
\newcommand{\bcsp}[2]{\left\{x_i^2 - x_i | i \in [#1]\right\} \cup \left\{\sum_{i=1}^n x_i - #2\right\}}
\newcommand{\csp}{\left\{x_i^2 - x_i | i \in [n]\right\}}
\newcommand{\clique}{\left\{x_i^2 - x_i | i \in V\right\} \cup \left\{x_ix_j | (i,j) \notin E\right\}}
\newcommand{\bisec}{\left\{x_i^2 - x_i | i \in [n]\right\} \cup \left\{\sum_i x_i - \frac{n}{2}\right\}}
\newcommand{\bspca}[2]{\left\{x_i^3 - x_i | i \in [#1]\right\} \cup \left\{\sum_i x_i^2 - #2\right\}}
