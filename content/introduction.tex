...
%To see one way ideal membership relates to SOS relaxations, imagine we are given a set of polynomials $\{s_i\}$ and a polynomial $q$ which are claimed to prove that $r$ is nonnegative on the zeros of $\cP$ via the polynomial identity
%\begin{align}
%r = \sum_i s_i^2 + q,
%\end{align}
