...
In this dissertation we give some of the first theory on the bit complexity of SOS proofs, and provide a checkable, sufficient criterion for the existence of SOS proofs involving only polynomials without enormous coefficients. 
We also show how our criterion can be checked for some common examples of combinatorial optimization problems, including \textsc{Matching} and \textsc{TSP}. 
