...
\end{proof}
\prettyref{lem:grobnereffective} is unsurprising, as Gr\"obner bases first originated as a method to solve the polynomial ideal problem \cite{}. 
...
Of course, not every problem falls so neatly into this classification. There are many natural problems whose solution spaces have a small set of generating
...
Even though the generating polynomials are not a Gr\"obner basis, they can still be $k$-effective for constant $k$.
