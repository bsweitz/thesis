...
Recall the definition of Gr\"obner basis from \prettyref{def:grobner}, and in particular recall that we can define a multivariate divison algorithm with respect to a Gr\"obner basis such that every polynomial has a unique remainder. The following lemma is an obvious consequence of the division algorithm.
