...
$1 \in \gen{\cP}$ if and only if $\cP$ is infeasible. In other words, there is no $\alpha \in \C^n$ such that $p(\alpha) = 0$ for every $p \in \cP$.
\end{lemma}
